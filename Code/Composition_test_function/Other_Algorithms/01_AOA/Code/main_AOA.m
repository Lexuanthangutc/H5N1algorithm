...
%
% Recode by: Le Xuan Thang____________________________________________________________________________________
clc
clear
close all
...
for F_ID = 16 : Number_of_function
    ...
    for i_times = 1 : Time2run
        % Call H5N1 function
        [GlobalBest_Cost,GlobalBest_Position,BestCosts,Store]=AOA(nPop,Max_iter,VarMin,VarMax,nVar,CostFunction,F_ID);

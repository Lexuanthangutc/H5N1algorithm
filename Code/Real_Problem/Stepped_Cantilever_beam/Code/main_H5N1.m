...
for F_ID = 1 : Number_of_function
    ...
    Problem_Name = ('Stepped_Cantilever_Beam_Problem');


    VarMin = [1 30 2.4 45 2.4 45 1 30 1 30];
    VarMax = [5 65 3.1 60 3.1 60 5 65 5 65];
    nVar = length(VarMin);
    CostFunction = @Stepped_Cantilever_Beam_Problem;
...
[g,geq] = Stepped_Cantilever_Beam_Constraints(GBest_Position)
Cost = Stepped_Cantilever_Beam_Cost(GBest_Position)
%% Lưu
% Tạo tên tệp tin

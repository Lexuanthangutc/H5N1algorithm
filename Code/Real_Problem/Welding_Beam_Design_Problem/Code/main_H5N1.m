...
for F_ID = 1 : Number_of_function
    ...
    Problem_Name = ('Weld_Beam_Design_Problem');

    VarMin = [0.1 0.1 0.1 0.1];
    VarMax = [2.0 10.0 10.0 2.0];
    nVar = length(VarMin);
    CostFunction = @Weld_Beam_Design_Problem;
...
GBest_Position = [0.1829	4.0483	9.3666	0.2059];
[g,geq] = Weld_Beam_Constraints(GBest_Position)
Cost = Weld_Beam_Cost(GBest_Position)
%% Lưu
% Tạo tên tệp tin

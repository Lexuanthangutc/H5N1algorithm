...
for F_ID = 1 : Number_of_function
    ...
    Problem_Name = ('Tension_Compression_Spring_Design_Problem');

    VarMin = [0.05  0.25    2];
    VarMax = [2     1.3     15];
    nVar = length(VarMin);
    CostFunction = @Tension_Compression_Spring_Design_Problem;
...
[g,geq] = Tension_Compression_Spring_Design_Constraints(GBest_Position)
Cost = Tension_Compression_Spring_Design_Cost(GBest_Position)
%% Lưu
% Tạo tên tệp tin

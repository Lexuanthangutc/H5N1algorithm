% SSA convert for structure 
% by Le Xuan Thang
% collector is working for collect the data
...
for F_ID = 1 : Number_of_function
    ...
    for i_times = 1 : Time2run
        % Call H5N1 function
        [GlobalBest_Cost,GlobalBest_Position,BestCosts,Store]=SSA(nPop,Max_iter,VarMin,VarMax,nVar,CostFunction);
